...
//     await Promise.all([fetchReminders(), fetchUser()]);
//   }
...
//     try {
//       const res = await api.put('/auth/drink', { liters });
//       setConsumed(res.data.consumedToday);
//     } catch(e) { console.error(e); }
//   }
...
//   const lastSent = reminders.flatMap(r => r.history || [])
...
//           <ul className="list">
//             {reminders.map(r => {
//               const isFuture = new Date(r.nextAt).getTime() > now;
//               const perGlass = (dailyWater / activeCount).toFixed(2);
//               return (
...
//                         className="btn small" 
//                         disabled={isFuture} 
//                         style={{backgroundColor: isFuture ? '#ccc' : ''}}
//                         onClick={()=>{markDrank(perGlass); snooze(r._id, 5);}}
//                       >
//                         Drank / Snooze 5m
//                       </button>{' '}
...
//                       </button>{' '}
//                       <button className="btn small danger" onClick={()=>deleteReminder(r._id)}>Delete</button>
//                     </div>
//                   </div>
//                 </li>
//               );
